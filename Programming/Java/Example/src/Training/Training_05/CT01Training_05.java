...
public class CT01Training_05 {
	 ...
	 * 상점 메뉴
	 */
	private static final int STORE_MENU_BUY_WEAPON_A = 1;
	private static final int STORE_MENU_BUY_WEAPON_B = 2;
	private static final int STORE_MENU_LEAVE = 3;
	...
	/** 상점 메뉴를 출력한다 */
	private static void printMenu_Store() {
		System.out.println("=====> 상점 메뉴 <=====");
		System.out.println("1. 무기 A 구입 (공격력 : 5, 금액 : 500)");
		System.out.println("2. 무기 B 구입 (공격력 : 2 ~ 8, 금액 : 1000)");
